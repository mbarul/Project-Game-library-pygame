...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        # Utworzenie egzemplara przechowującego dane statystyczne dotyczące gry oraz utworzenie ezglemplarza klasy Scoreboard
    ...
    def _ship_hit(self):
        ...
        if self.stats.ships_left > 0:
            #Zmniejszenie wartości przechowywanej w ships_lelf i uaktualnienie tablicy wyników
